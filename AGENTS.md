...
- Single canonical M² checkout: /Users/mitchellmiler/Documents/mitchjmiller-html-migration (python3 ~/Documents/ai-os/scripts/where.py mj2.pro resolves here). Do not create a second clone or long-lived worktree for this repository; a temporary clone for a build or release is removed when the task ends.
- Mitch approved a separate personal portfolio project at /Users/mitchellmiler/Documents/mitchjmiller.com (where.py mitchjmiller.com), with its own GitHub repository planned as CKAWEBUILDER/mitchjmiller-portfolio. That is a different site and project, not a second M² checkout. The prior stale clone was preserved at /Users/mitchellmiler/Archive/2026-09-25/mitchjmiller.com-stale-clone/; see handoffs/checkout-reconciliation-2026-09-25.md and the personal site's own AGENTS.md.
