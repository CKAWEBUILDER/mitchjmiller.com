...
Current gate: build and validate the new-domain release, publish it, activate the client portal hostname, then complete GSC/GA4/LinkedIn updates. The M² LinkedIn page will use the new squared identity; Rio's invite requires exact profile resolution before it is sent.
