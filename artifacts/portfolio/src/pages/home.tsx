...
import { headshot, caseStudyImages } from "@/lib/images";
...
const liveWork = [
  {
    ...
    url: "https://www.dignityhealth.org/conditions-and-treatments",
    description: "Enterprise healthcare content architecture and condition/treatment discovery surface. 10,000+ entries, 250K+ annual organic visits."
  },
  {
            ...
            <div>
              ...
              <div className="bg-muted/40 border border-border rounded-lg px-4 py-3">
                ...
                <p className="text-sm text-primary leading-relaxed">
                  SEO Director · AEO/GEO Lead · AI Search Strategist · Agentic AI Engineer · Technical SEO/Product Manager · Organic Growth Lead
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              {
                track: "Track 3",
                title: "Applied AI Systems & Growth Products",
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {featuredCases.map((cs) => {
              const img = caseStudyImages[cs.slug];
              return (
      ...
      <section className="py-20 bg-primary text-primary-foreground border-t border-border">
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          ...
          <p className="text-primary-foreground/70 mb-10 text-sm max-w-xl">
            Personal prototypes, measurement infrastructure, and workflow experiments — each one replacing a commercial tool.
          </p>
