...
import { ResumeDownloadDialog, ResumeChooser } from "./resume-download-dialog";
    ...
    <div className="min-h-screen flex flex-col bg-background font-sans">
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto px-4 md:px-8 h-16 flex items-center justify-between">
          ...
          <details className="parity-mobile-menu md:hidden">
            <summary className="p-2 text-primary cursor-pointer list-none" aria-label="Open navigation">
              <Menu size={24} /><span className="sr-only">Navigation</span>
            </summary>
            <div className="absolute inset-x-0 top-full border-b border-border/40 bg-background px-4 py-4 shadow-sm">
              <nav aria-label="Mobile navigation" className="flex flex-col space-y-4">
                ...
                <ResumeDownloadDialog>
                  <button type="button" className="text-sm font-medium text-secondary text-left">Download Resume</button>
                </ResumeDownloadDialog>
              </nav>
            </div>
          </details>
      ...
      <a href="#main-content" className="parity-skip-link">Skip to content</a>
