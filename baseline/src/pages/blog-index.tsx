...
const writingItems = visibleBlogPosts.map((p: any) => ({
...
export default function BlogIndex() {
  ...
  return (
    <Layout>
      ...
      />
      <div data-filter-group="blog" data-filter-default="all" className="container mx-auto px-4 md:px-8 py-24 max-w-4xl">
        ...
        <div className="space-y-12">
          {items.map((post) => (
            <div key={post.href} data-filter-card={post.kind} className="border-b border-border pb-12 last:border-0">
