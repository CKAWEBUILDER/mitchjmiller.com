...
for(const file of walk('dist').filter(p=>p.endsWith('.html'))){
 ...
 if(route==='/case-studies/sfc-surf-school/'&&!/rel=["']canonical/.test(html))html=html.replace('</head>','<link rel="canonical" href="https://mitchjmiller.com/case-studies/sfc-surf-school/"/></head>');
