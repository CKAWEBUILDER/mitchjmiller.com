...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="site-shell">
    ...
    <header className="site-header">
      ...
      {open && <nav id="mobile-navigation" aria-label="Mobile navigation" className="mobile-nav">{[...links,{href:"https://mitchjmiller.com/",label:"Mitch’s portfolio"},{href:"/contact",label:"Let’s talk"}].map(l=><Link key={l.href} href={l.href} onClick={()=>setOpen(false)}>{l.label}<ArrowUpRight size={18}/></Link>)}</nav>}
    </header>
    ...
    <footer className="site-footer"><div className="site-wrap">
      ...
      <div className="footer-bottom"><p>© {new Date().getFullYear()} Mitchell Miller<br/><span>Strategy that gets built. Work you can explore.</span></p><nav aria-label="Footer navigation"><a href="https://mitchjmiller.com/">Mitch’s portfolio</a><Link href="/collab-ideas">Work together</Link><Link href="/systems">My approach</Link><a href="https://linkedin.com/in/mitchelljmillerjr" target="_blank" rel="noopener noreferrer">LinkedIn ↗</a><a href="mailto:mitchelljmillerjr26@gmail.com">Email ↗</a></nav></div>
    </div></footer>
  </div>;
}
