...
export const caseStudies = [
  ...
  },
  {
    ...
    title: "CommonSpirit Locations Conversion Engine",
    thesis: "1,000+ Yext-driven entity pages driving massive appointment volume",
    role: "Product Manager, SEO & Web Analytics",
    context: "Dignity Health / CommonSpirit Health, 1,000+ locations, 20+ regional markets",
    problem: "Fragmented location data, poor entity coverage, low conversion from search-to-action",
    system: "Yext parent/child entity architecture, dynamic CMS templates, structured data, NAP cleanup, syndication to Google, Apple Maps, Siri, Alexa, attribution modeling",
    partners: "Data Science, engineering, Yext, regional market teams",
    tools: "Yext, GA4, Adobe Analytics, GSC, CMS, Python/SQL/BigQuery",
    proof: "175K calls/directions, 88K appointments, $15.21M FY22 attributable revenue",
    showsHiringManagers: "End-to-end product ownership linking technical SEO directly to multi-million dollar revenue outcomes.",
  ...
  },
  {
    ...
    title: "CommonSpirit Medical Content Library",
    thesis: "Patient acquisition content system competing with WebMD and Mayo Clinic",
    role: "PM, SEO & Web Analytics",
    context: "Dignity Health / CommonSpirit, patient acquisition content system",
    problem: "Competitors (WebMD, Cleveland Clinic, Mayo Clinic) owned condition/treatment search; no structured patient-acquisition content surface",
    system: "10,000+ condition/treatment entries, FAQ schema, competitive intelligence, early LLM-assisted content, AI-answer readiness architecture",
    partners: "Content Strategy, Medical Reviewers, Engineering",
    tools: "CMS, Schema Markup, Semrush",
    proof: "250K+ annual organic visits, ~$200K organizational value",
    showsHiringManagers: "Ability to architect scalable content systems that capture top-of-funnel intent.",
  ...
  },
  {
    ...
    thesis: "Strategic migration leverage using dynamic metadata",
    role: "PM, SEO & Web Analytics",
    context: "Adobe Experience Manager migration strategy",
    problem: "Top-down migration mandate with low regional executive buy-in",
    system: "Demonstrated AEM content fragmentation for dynamic metadata syndication (title tags, descriptions, alts, headers, OG images) across regions/brands; converted mandate into adoption",
    partners: "Adobe Architects, Regional Leaders",
    tools: "AEM, Data mapping",
    proof: "Secured executive buy-in through clear demonstration of operational efficiency.",
    showsHiringManagers: "Technical fluency with AEM and ability to translate engineering capabilities into business value.",
