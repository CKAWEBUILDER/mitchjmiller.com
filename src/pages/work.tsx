...
export default function Work() {
  ...
  const categories = ["Core Portfolio", "Enterprise SEO", "AEO/GEO & AI Search", "AI Products", "Selected Builds"];
  ...
  const categoryMap: Record<string, string> = {
    ...
    'domainsignal': 'Selected Builds',
    'date-night': 'Selected Builds',
    'vet-advocates-growth-system': 'Selected Builds'
  };
    ...
    <Layout>
      ...
      <div className="container mx-auto px-4 md:px-8 py-24">
        <div className="mb-10 max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Work that maps to the roles.</h1>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Enterprise SEO, AEO/GEO measurement, and AI search systems are the main portfolio.
            Side builds are available as supporting evidence, not the lead story.
          </p>
        </div>
        ...
        {filter === "Selected Builds" && (
          <div className="mb-8 rounded-xl border border-border bg-muted/30 p-5">
            <p className="text-sm text-muted-foreground leading-relaxed">
              These are side projects and growth builds. They support technical range and product instincts,
              but the primary hiring signal remains enterprise SEO, AEO/GEO, and AI search systems.
            </p>
          </div>
        )}
